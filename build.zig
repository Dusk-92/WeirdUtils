...
pub fn build(b: *std.Build) void {
    ...
    inline for (&[_]struct { name: []const u8, screenshot: bool, interact: bool, outline: bool }{
        .{ .name = "full", .screenshot = true, .interact = true, .outline = true },
        .{ .name = "screenshot", .screenshot = true, .interact = false, .outline = false },
        .{ .name = "interact", .screenshot = false, .interact = true, .outline = false },
        .{ .name = "outline", .screenshot = false, .interact = false, .outline = true },
    }) |variant| {
